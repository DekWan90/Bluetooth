...
public:
    ...
    public:
        ...
        enum DeviceClass major_device_class;
        enum ServiceClass service_class;

        std::string getDeviceClass();
        std::string getMajorDeviceClass();
        std::string getServiceClass();
        std::string FormatDate( const char *format, time_t time );

        int Channels();

    private:
        std::string getDeviceClass( DeviceClass device_class );
    };
    ...
    std::vector<struct Data> Mengintip();
